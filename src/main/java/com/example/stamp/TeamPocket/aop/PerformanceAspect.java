package com.example.stamp.TeamPocket.aop;
...
public class PerformanceAspect {
    ...
    //특정 어노테이션을 대상지정
    @Pointcut("@annotation(com.example.stamp.TeamPocket.annotation.RunningTime)")
    private void enableRunningTime(){}

    //기본 패키지의 모든 메소드
    @Pointcut("execution(* com.example.stamp.TeamPocket..*.*(..))")
    private void cut(){}
